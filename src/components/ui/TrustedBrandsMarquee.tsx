...
const row1Items: MarqueeItem[] = [
  { abbr: 'BIS',  name: 'BIS Licensed',        color: 'text-blue-400',   bg: 'bg-blue-500/10'    },
  { abbr: 'ISO',  name: 'ISO 9001:2015',        color: 'text-emerald-400',bg: 'bg-emerald-500/10' },
  { abbr: 'CPWD', name: 'CPWD Approved',        color: 'text-amber-400',  bg: 'bg-amber-500/10'   },
  { abbr: 'UPJN', name: 'Jal Nigam UP',         color: 'text-blue-300',   bg: 'bg-blue-400/10'    },
  { abbr: 'L&T',  name: 'L&T Construction',     color: 'text-slate-300',  bg: 'bg-slate-400/10'   },
  { abbr: 'NTPC', name: 'NTPC Limited',          color: 'text-orange-400', bg: 'bg-orange-500/10'  },
  { abbr: 'RVNL', name: 'RVNL',                 color: 'text-violet-400', bg: 'bg-violet-500/10'  },
  { abbr: 'TATA', name: 'Tata Projects',         color: 'text-blue-400',   bg: 'bg-blue-500/10'    },
  { abbr: 'DJB',  name: 'Delhi Jal Board',       color: 'text-cyan-400',   bg: 'bg-cyan-500/10'    },
];

const row2Items: MarqueeItem[] = [
  { abbr: 'PHED',  name: 'PHED Rajasthan',       color: 'text-amber-300',  bg: 'bg-amber-400/10'   },
  { abbr: 'MJP',   name: 'MJP Maharashtra',       color: 'text-indigo-400', bg: 'bg-indigo-500/10'  },
  { abbr: 'IRCON', name: 'IRCON International',   color: 'text-slate-300',  bg: 'bg-slate-400/10'   },
  { abbr: 'NDMC',  name: 'NDMC New Delhi',        color: 'text-green-400',  bg: 'bg-green-500/10'   },
  { abbr: 'GWSSB', name: 'GWSSB Gujarat',         color: 'text-blue-300',   bg: 'bg-blue-400/10'    },
  { abbr: 'PWD',   name: 'PWD Uttar Pradesh',     color: 'text-orange-300', bg: 'bg-orange-400/10'  },
  { abbr: 'BWSSB', name: 'BWSSB Bangalore',       color: 'text-purple-400', bg: 'bg-purple-500/10'  },
  { abbr: 'HMDA',  name: 'HMDA Hyderabad',        color: 'text-cyan-300',   bg: 'bg-cyan-400/10'    },
  { abbr: 'ISI',   name: 'ISI Mark Holder',       color: 'text-blue-400',   bg: 'bg-blue-500/10'    },
];
