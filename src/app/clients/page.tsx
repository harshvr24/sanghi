...
import { ArrowRight, Droplets, Landmark, HardHat, Building2, LayoutGrid, MapPin, Package } from 'lucide-react';
...
const allClients: Client[] = [
  // Water Utilities
  { abbr: 'UPJN',  name: 'Jal Nigam',                      sub: 'Uttar Pradesh',     sector: 'Water Utilities', color: 'text-blue-400',   bg: 'bg-blue-500/10'    },
  { abbr: 'PHED',  name: 'PHED',                            sub: 'Rajasthan',         sector: 'Water Utilities', color: 'text-amber-400',  bg: 'bg-amber-500/10'   },
  { abbr: 'DJB',   name: 'Delhi Jal Board',                 sub: 'Delhi',             sector: 'Water Utilities', color: 'text-cyan-400',   bg: 'bg-cyan-500/10'    },
  { abbr: 'MJP',   name: 'Maharashtra Jeevan Pradhikaran',  sub: 'Maharashtra',       sector: 'Water Utilities', color: 'text-indigo-400', bg: 'bg-indigo-500/10'  },
  { abbr: 'GWSSB', name: 'GWSSB',                           sub: 'Gujarat',           sector: 'Water Utilities', color: 'text-sky-400',    bg: 'bg-sky-500/10'     },
  { abbr: 'BWSSB', name: 'BWSSB',                           sub: 'Bangalore, KA',     sector: 'Water Utilities', color: 'text-purple-400', bg: 'bg-purple-500/10'  },
  { abbr: 'MPJN',  name: 'Jal Nigam',                       sub: 'Madhya Pradesh',    sector: 'Water Utilities', color: 'text-orange-400', bg: 'bg-orange-500/10'  },
  // Government
  { abbr: 'CPWD',  name: 'CPWD',                            sub: 'Central Govt.',     sector: 'Government',      color: 'text-emerald-400',bg: 'bg-emerald-500/10' },
  { abbr: 'PWD',   name: 'PWD',                             sub: 'Uttar Pradesh',     sector: 'Government',      color: 'text-yellow-400', bg: 'bg-yellow-500/10'  },
  { abbr: 'NDMC',  name: 'NDMC',                            sub: 'New Delhi',         sector: 'Government',      color: 'text-green-400',  bg: 'bg-green-500/10'   },
  { abbr: 'BDA',   name: 'Bhopal Dev. Authority',           sub: 'Madhya Pradesh',    sector: 'Government',      color: 'text-teal-400',   bg: 'bg-teal-500/10'    },
  { abbr: 'HMDA',  name: 'HMDA',                            sub: 'Hyderabad, TG',     sector: 'Government',      color: 'text-cyan-300',   bg: 'bg-cyan-400/10'    },
  // Infrastructure
  { abbr: 'NTPC',  name: 'NTPC Limited',                    sub: 'Power Infrastructure',sector: 'Infrastructure',color: 'text-orange-400', bg: 'bg-orange-500/10'  },
  { abbr: 'RVNL',  name: 'RVNL',                            sub: 'Rail Vikas Nigam',  sector: 'Infrastructure',  color: 'text-violet-400', bg: 'bg-violet-500/10'  },
  { abbr: 'IRCON', name: 'IRCON International',             sub: 'Railway Construction',sector: 'Infrastructure',color: 'text-slate-300',  bg: 'bg-slate-400/10'   },
  { abbr: 'L&T',   name: 'L&T Construction',                sub: 'EPC Contractor',    sector: 'Infrastructure',  color: 'text-blue-300',   bg: 'bg-blue-400/10'    },
  { abbr: 'TATA',  name: 'Tata Projects',                   sub: 'Infrastructure Div.',sector: 'Infrastructure', color: 'text-red-400',    bg: 'bg-red-500/10'     },
  // Municipal
  { abbr: 'LMC',   name: 'Lucknow Municipal Corp.',         sub: 'Uttar Pradesh',     sector: 'Municipal',       color: 'text-pink-400',   bg: 'bg-pink-500/10'    },
  { abbr: 'KNN',   name: 'Kanpur Nagar Nigam',              sub: 'Uttar Pradesh',     sector: 'Municipal',       color: 'text-rose-400',   bg: 'bg-rose-500/10'    },
  { abbr: 'VNN',   name: 'Varanasi Nagar Nigam',            sub: 'Uttar Pradesh',     sector: 'Municipal',       color: 'text-orange-300', bg: 'bg-orange-400/10'  },
  { abbr: 'ANN',   name: 'Agra Nagar Nigam',                sub: 'Uttar Pradesh',     sector: 'Municipal',       color: 'text-yellow-300', bg: 'bg-yellow-400/10'  },
];

const featuredProjects: FeaturedProject[] = [
  {
    client: 'Jal Nigam, Uttar Pradesh',
    project: 'Urban Water Distribution Network Expansion',
  ...
  },
  {
    ...
    project: 'Bridge Crossing & Pump House Infrastructure',
    location: 'Multiple States, India',
    spec: 'DI Flanged Pipes · DN 150–600 · K12 Pressure Class',
    abbr: 'L&T',
    sector: 'Infrastructure',
    accentFrom: 'from-muted/60',
    accentColor: 'text-slate-300',
  },
  {
    client: 'CPWD',
    project: 'Government Township Water Supply Systems',
    location: 'Delhi NCR & Multiple Zones',
...
const tabs = [
  ...
  { label: 'Water Utilities',icon: Droplets    },
  { label: 'Government',     icon: Landmark    },
  { label: 'Infrastructure', icon: HardHat     },
  { label: 'Municipal',      icon: Building2   },
];

const sectorStats = [
  { value: '1,200+', label: 'Total Clients'    },
