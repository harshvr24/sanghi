...
const featuredProductModelMap: Record<string, { type: string; color: string; metalness: number; roughness: number }> = {
  ...
  // CI Pipes — lighter grey, rougher surface than DI
  'ci-double-flange-pipe':  { type: 'flanged-pipe',    color: '#4a5568', metalness: 0.65, roughness: 0.55 },
  'ci-spun-pipe-ss':        { type: 'ss-pipe',          color: '#4a5568', metalness: 0.65, roughness: 0.55 },
  // Valves
...
// Clientele preview on homepage
const homepageClients = [
  { abbr: 'UPJN',  name: 'Jal Nigam UP',         sector: 'Water Utilities', color: 'text-blue-400',   bg: 'bg-blue-500/10'    },
  { abbr: 'PHED',  name: 'PHED Rajasthan',        sector: 'Water Utilities', color: 'text-amber-400',  bg: 'bg-amber-500/10'   },
  { abbr: 'DJB',   name: 'Delhi Jal Board',       sector: 'Water Utilities', color: 'text-cyan-400',   bg: 'bg-cyan-500/10'    },
  { abbr: 'CPWD',  name: 'CPWD',                  sector: 'Government',      color: 'text-emerald-400',bg: 'bg-emerald-500/10' },
  { abbr: 'NTPC',  name: 'NTPC Limited',           sector: 'Infrastructure',  color: 'text-orange-400', bg: 'bg-orange-500/10'  },
  { abbr: 'L&T',   name: 'L&T Construction',      sector: 'Infrastructure',  color: 'text-slate-300',  bg: 'bg-slate-400/10'   },
  { abbr: 'RVNL',  name: 'RVNL',                  sector: 'Infrastructure',  color: 'text-violet-400', bg: 'bg-violet-500/10'  },
  { abbr: 'MJP',   name: 'MJP Maharashtra',        sector: 'Water Utilities', color: 'text-indigo-400', bg: 'bg-indigo-500/10'  },
  { abbr: 'TATA',  name: 'Tata Projects',          sector: 'Infrastructure',  color: 'text-blue-300',   bg: 'bg-blue-400/10'    },
  { abbr: 'PWD',   name: 'PWD UP',                sector: 'Government',      color: 'text-yellow-400', bg: 'bg-yellow-500/10'  },
];
